...
def config():
    malaria_consortium = Charity(
        ...
        long_desc = textwrap.dedent("""\
            Malaria kills over 600,000 people annually, mostly children under 5 in sub-Saharan Africa. 
    ...
    helen_keller_international = Charity(
        ...
        long_desc = textwrap.dedent("""\
            Vitamin A deficiency leaves children vulnerable to infections and can lead to death. 
    ...
    new_incentives = Charity(
        ...
        long_desc = textwrap.dedent("""\
            In Nigeria, 43% of infants did not receive all recommended childhood vaccines in 2019. 
